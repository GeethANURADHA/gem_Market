    ...
    <Float speed={2} rotationIntensity={0.2} floatIntensity={0.5}>
      <mesh ref={meshRef} castShadow receiveShadow>
        ...
        <MeshTransmissionMaterial
          ...
          distortion={0.1}
          distortionScale={0.1}
          temporalDistortion={0} /* Disabled for performance */
  ...
  return (
    <div className="gem-canvas-container">
      ...
      >
        ...
        {/* Environment changed from 'city' to 'studio' (lighter) */}
        <Environment preset="studio" />
        {/* resolution reduced from 1024 to 256 for performance */}
        <ContactShadows position={[0, -2.5, 0]} resolution={256} scale={15} blur={2.5} opacity={0.4} far={10} color="#000000" />
      </Canvas>
    </div>
  );
};
