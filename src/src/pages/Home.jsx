...
const Home = () => {
  ...
  const handleAddSubmit = async () => {
    ...
    try {
      ...
      alert(`Failed to add gem type: ${errorMessage}\n\nMake sure the Supabase table exists and 'gemstone_bucket' storage is set up with public access.`);
    }
    setSaving(false);
  };
